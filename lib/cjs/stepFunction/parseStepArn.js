...
exports.getEnvironmentVars = exports.parseStepArn = void 0;
const ensureFunctionName_1 = require("../invoke/ensureFunctionName");
// TODO: look into making the two arn parsing functions into one
function parseStepArn(arn) {
...
exports.parseStepArn = parseStepArn;
function parseFullyQualifiedString(arn) {
    ...
    return {
        region,
        account,
        fn: ensureFunctionName_1.ensureFunctionName(fn),
        stage,
        appName,
    };
}
...
function parsePartiallyQualifiedString(fn) {
    const output = Object.assign(Object.assign({}, getEnvironmentVars()), { fn: ensureFunctionName_1.ensureFunctionName(fn.split(":").pop()) });
