...
function setContext(ctx) {
    activeState["context"] = Object.assign({}, ctx, defaultState["context"]);
...
function addToLocalContext(ctx) {
    activeState.localContext = Object.assign({}, activeState.localContext, ctx);
    return logging_api_1.loggingApi;
}
...
exports.getContext = () => {
    ...
    const context = Object.assign({}, activeState["context"], envContext);
    return context;
};
